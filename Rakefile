...
Jeweler::Tasks.new do |gem|
  gem.name        = "toastr-rails-sass"
  gem.version     = File.open('VERSION').read
  gem.authors     = ["Tyler Gannon","Aaron Ciaghi"]
  gem.email       = ["tgannon@gmail.com","aaron.ciaghi@gmail.com"]
  gem.homepage    = "https://github.com/ict4g/toastr-rails-sass"
...
Rake::RDocTask.new do |rdoc|
  ...
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title = "toastr-rails-sass #{version}"
